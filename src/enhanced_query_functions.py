...
from reference_resolver_functions import resolve_reference, resolve_reference_by_title, format_reference_citation, validate_reference_match
        ...
        if resolve_missing:
            ...
            if original_ref:
                ...
                if is_valid_match:
                    ...
                    result["external_reference"]["formatted_citation"] = format_reference_citation(original_ref)
...
def display_enhanced_result(result: Dict) -> str:
    ...
    if result.get("attribution_mismatch"):
        ...
        if result.get("external_reference"):
            lines.append("   The external reference above is likely the original describing paper.")
...
def query_multiple_species_enhanced(
    ...
    for i, species in enumerate(species_list):
        ...
        info = enhanced_query_pbdb(species.strip(), resolve_missing, bhl_api_key)
